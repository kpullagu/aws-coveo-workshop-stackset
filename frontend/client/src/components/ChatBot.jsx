...
const ChatBot = ({ isOpen, onToggle, backendMode, sessionId, memoryId, onSessionEnd }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        text: details.includes('Authenticated user identity')
          ? 'Authenticated user identity is required for memory-enabled chat. Please log in again and retry.'
            ...
            >
              ...
              >
                ...
                <ChatInput>
                  ...
                  {backendMode === 'coveoMCP' && messages.length > 1 && (
